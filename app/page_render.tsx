  ...
  return (
    ...
    <main className="flex h-full w-full relative flex-col items-center justify-center overflow-hidden">
      <div className={'slide slide1'}>
        ...
        <img alt={'Pictures of people'} src={'https://nyuvsa.com/api/images/image.png'} className={'absolute z-0 object-cover'}/>
      </div>
      ...
      <div className={'slide slide2'}>
        ...
        <img alt={'Pictures of people'} src={'https://nyuvsa.com/api/images/image2.png'} className={'absolute z-0 object-cover'}/>
      </div>
      <div className={'slide slide3'}>
        ...
        <img alt={'Pictures of people'} src={'https://nyuvsa.com/api/images/image3.png'} width={2000} height={2000} className={'absolute z-0 object-cover'}/>
      </div>
