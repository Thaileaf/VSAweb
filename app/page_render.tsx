  ...
  return (
    ...
    <main className="flex h-full w-full relative flex-col items-center justify-center overflow-hidden">
      <div className={'slide slide1'}>
        ...
        <Image alt={'Pictures of people'} src={'/image.png'} className={'absolute z-0 object-cover'}/>
      </div>
      ...
      <div className={'slide slide2'}>
        ...
        <Image alt={'Pictures of people'} src={'/image2.png'} className={'absolute z-0 object-cover'}/>
      </div>
      <div className={'slide slide3'}>
        ...
        <Image alt={'Pictures of people'} src={'/image3.png'} width={2000} height={2000} className={'absolute z-0 object-cover'}/>
      </div>
